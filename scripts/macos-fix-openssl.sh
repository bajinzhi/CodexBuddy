...
app_path="${1:-src-tauri/target/release/bundle/macos/CodexBuddy.app}"
...
bin_path="${app_path}/Contents/MacOS/codex-buddy"
daemon_path="${app_path}/Contents/MacOS/codex_buddy_daemon"
daemonctl_path="${app_path}/Contents/MacOS/codex_buddy_daemonctl"
daemon_source="${DAEMON_BINARY_PATH:-src-tauri/target/release/codex_buddy_daemon}"
daemonctl_source="${DAEMONCTL_BINARY_PATH:-src-tauri/target/release/codex_buddy_daemonctl}"
