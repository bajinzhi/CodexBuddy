...
pub fn run() {
    ...
    let app = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            codex::unarchive_thread,
            codex::delete_thread,
            codex::list_loaded_threads,
            codex::unsubscribe_thread,
            codex::list_thread_background_terminals,
            codex::terminate_thread_background_terminal,
            codex::clean_thread_background_terminals,
            codex::compact_thread,
            codex::set_thread_name,
            codex::thread_goal_get,
            codex::thread_goal_set,
            codex::thread_goal_clear,
