...
export function ApprovalToasts({
  ...
  const renderParamValue = (value: unknown) => {
    if (value === null || value === undefined) {
      return { text: t("common:labels.none"), isCode: false };
    }
          ...
          >
            <ToastHeader className="approval-toast-header">
              <ToastTitle className="approval-toast-title">
                {t("app:notifications.approvalNeeded")}
              </ToastTitle>
              {workspaceName ? (
            ...
            <div className="approval-toast-details">
              {entries.length ? (
                ...
                <div className="approval-toast-detail approval-toast-detail-empty">
                  {t("app:notifications.noExtraDetails")}
                </div>
              )}
            </div>
            <ToastActions className="approval-toast-actions">
              ...
              {commandInfo && onRemember ? (
                <button
                  ...
                  title={t("app:notifications.allowCommandsThatStartWith", {
                    command: commandInfo.preview,
                  })}
                >
                  {t("common:actions.alwaysAllow")}
                </button>
              ) : null}
              <button
                className="primary"
