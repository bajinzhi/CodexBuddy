    ...
    <div className="sidebar-header">
      ...
      <div className="sidebar-header-actions">
        ...
        <button
          ...
          data-tauri-drag-region="false"
          aria-label={t("sidebar.refreshAllThreads")}
          type="button"
          title={t("sidebar.refreshAllThreads")}
          data-tooltip={t("sidebar.refreshAllThreads")}
          data-tooltip-align="end"
          data-tooltip-placement="bottom"
        ...
        <button
          ...
          data-tauri-drag-region="false"
          aria-label={isSearchOpen ? t("sidebar.closeSearch") : t("sidebar.toggleSearch")}
