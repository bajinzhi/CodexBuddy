...
function buildDefaultAiRadarSettings(): AiRadarSettings {
  return {
    ...
    sources: [
      ...
      {
        id: "media-arxiv-agent-memory-context",
        name: "arXiv Agent Memory & Context",
        kind: "atom",
        url: "https://export.arxiv.org/api/query?search_query=all:%22agent%20memory%22%20OR%20all:%22context%20engineering%22%20OR%20all:%22long%20context%22&sortBy=submittedDate&sortOrder=descending&max_results=20",
        query: null,
        enabled: true,
        channel: "media",
        createdAtMs: null,
      ...
      {
        id: "media-wechat-xinzhiyuan",
        name: "新智元微信公众号",
        kind: "wechatOfficialAccount",
        url: null,
        query: "/wechat/sogou/%E6%96%B0%E6%99%BA%E5%85%83",
        enabled: true,
        channel: "media",
        createdAtMs: null,
      },
      {
        id: "media-wechat-51cto-tech",
        name: "51CTO技术栈微信公众号",
        kind: "wechatOfficialAccount",
        url: null,
        query: "/wechat/sogou/51CTO%E6%8A%80%E6%9C%AF%E6%A0%88",
        enabled: true,
        channel: "media",
        createdAtMs: null,
      },
      {
        id: "media-wechat-tencent-cloud-developer",
        name: "腾讯云开发者微信公众号",
        kind: "wechatOfficialAccount",
        url: null,
        query: "/wechat/sogou/QcloudCommunity",
        enabled: true,
        channel: "media",
        createdAtMs: null,
      },
      {
        id: "media-wechat-aliyun-developer",
        name: "阿里云开发者微信公众号",
        kind: "wechatOfficialAccount",
        url: null,
        query:
      ...
      {
        id: "media-wechat-infoq",
        name: "InfoQ微信公众号",
        kind: "wechatOfficialAccount",
        url: null,
        query: "/wechat/sogou/infoqchina",
        enabled: true,
        channel: "media",
        createdAtMs: null,
      },
      {
        id: "media-wechat-taobao-tech",
        name: "大淘宝技术微信公众号",
        kind: "wechatOfficialAccount",
        url: null,
        query: "/wechat/sogou/AlibabaMTT",
        enabled: true,
        channel: "media",
        createdAtMs: null,
      },
      ...
      {
        id: "github-agent-memory-topic",
        name: "GitHub agent memory",
        kind: "githubSearch",
        query: '"agent memory" stars:>50 archived:false fork:false',
        url: null,
        enabled: true,
        channel: "github",
        createdAtMs: null,
      ...
      {
        id: "github-long-context-topic",
        name: "GitHub long context",
        kind: "githubSearch",
        query: '"long context" stars:>50 archived:false fork:false',
        url: null,
        enabled: true,
        channel: "github",
        createdAtMs: null,
      ...
      {
        id: "github-context-engineering-topic",
        name: "GitHub context engineering",
        kind: "githubSearch",
        query: '"context engineering" stars:>20 archived:false fork:false',
        url: null,
        enabled: true,
        channel: "github",
        createdAtMs: null,
