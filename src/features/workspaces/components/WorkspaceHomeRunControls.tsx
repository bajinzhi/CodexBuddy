        ...
        <SplitActionMenu
          ...
          actionButton={
            <button
              ...
              aria-label={t("workspaceHome.runMode.select")}
          ...
          toggleAriaLabel={t("workspaceHome.runMode.toggle")}
      ...
      <SplitActionMenu
        ...
        actionButton={
          <button
            ...
            aria-label={t("workspaceHome.models.select")}
            data-tauri-drag-region="false"
          >
            <span className="open-app-label">
        ...
        toggleClassName="ghost open-app-toggle"
        toggleAriaLabel={t("workspaceHome.models.toggle")}
        toggleIcon={<ChevronDown size={14} aria-hidden />}
      ...
      >
        {models.length === 0 && (
          <div className="workspace-home-empty">
            {t("workspaceHome.models.connectToLoad")}
          </div>
        )}
        {models.map((model) => {
          const isSelected =
        ...
        <div className="composer-select-wrap workspace-home-control">
          <div className="open-app-button">
            ...
            <select
              ...
              aria-label={t("workspaceHome.collaborationMode.label")}
      ...
      <div className="composer-select-wrap workspace-home-control">
        <div className="open-app-button">
          ...
          <select
            ...
            aria-label={t("workspaceHome.reasoning.label")}
